                ...
                <?php foreach ($applications as $app): ?>
                    <tr>
                        ...
                        <td class="d-flex gap-2 flex-wrap">
                            <a href="view_application.php?id=<?= $app['id'] ?>" class="btn btn-sm btn-outline-secondary">View</a>
                            <a href="edit_application.php?id=<?= $app['id'] ?>" class="btn btn-sm btn-outline-primary">Edit</a>
