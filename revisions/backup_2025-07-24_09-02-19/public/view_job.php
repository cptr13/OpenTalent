...
// Assigned contacts
$stmt = $pdo->prepare("
    SELECT contacts.id, contacts.full_name AS name, contacts.title, contacts.email, contacts.phone
    FROM job_contacts
...
<div class="container my-4">
        ...
        <div class="card-body">
            <p><strong>Company:</strong>
                <?php if (!empty($job['client_id'])): ?>
                    <a href="view_client.php?id=<?= $job['client_id'] ?>"><?= htmlspecialchars($job['company_name']) ?></a>
                <?php else: ?>
    ...
    <div class="card mb-4">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <a href="associate.php?job_id=<?= $job['id'] ?>&return=view_job.php?id=<?= $job['id'] ?>" class="btn btn-sm btn-success">+ Add Contact</a>
        </div>
            ...
            <?php else: ?>
                <?php foreach ($contacts as $contact): ?>
                    <li class="list-group-item">
                        <a href="view_contact.php?id=<?= $contact['id'] ?>"><?= htmlspecialchars($contact['name']) ?></a>
