...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        $stmt = $pdo->prepare("INSERT INTO jobs (title, description, location, client_id, contact_id, status) VALUES (?, ?, ?, ?, ?, ?)");
        $stmt->execute([$title, $description, $location, $client_id, $contact_id, $status]);
