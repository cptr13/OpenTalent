...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    $data = [
        ...
        'resume_filename' => $_POST['resume_filename'] ?? null,
    ...
    try {
        $sql = "INSERT INTO candidates (
                    name, first_name, last_name, email, secondary_email, phone, mobile, website,
                    street, city, state, zip, country,
                    experience, current_job, current_salary, expected_salary, skills,
                    skype_id, twitter, linkedin, facebook,
                    qualification, employer, additional_info, resume_filename,
